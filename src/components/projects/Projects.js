                  ...
                  <div className="flip-card-back">
                    <div className="card-body">
                      ...
                      <p>
                        ...
                        personal profile, and a comment section for each
                        climbing route, to converse with other climbers!
                      </p>

                      <p>
                        <b>
                          Built with React.js, using Google Firebase/Firestore
                          API for the backend and database.
                        </b>
                      </p>
                      <hr />
                ...
                <div className="flip-card-inner">
                  ...
                  <div className="flip-card-back">
                    <div className="card-body">
                      ...
                      <p>
                        Calculator for local child care provider. Calculates
                        wage and hours based on the clients frequency of pay,
                        number of hours, and hourly wage.
                      </p>
                      <p>
                        Also has an option to switch the calculation type based
                        on schooling.
                      </p>
                      <hr />
                ...
                <div className="flip-card-inner">
                  ...
                  <div className="flip-card-back">
                    <div className="card-body">
                      ...
                      <p>
                        Along with a calculator to showcase an estimated cost on
                        a project, based on the square footage.
                      </p>
                      <hr />
